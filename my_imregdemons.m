function [dfield,moving_reg] = my_imregdemons(moving,fixed,varargin)
...
[demons,userCancelled] = runMultiResolutionDemons(demons,options.NumIterations,options.PyramidLevels);
...
if userCancelled
    ...
    if nargout > 1
        moving_reg = imwarp(moving,dfield);
    end
...
function [demons,userCancelled] = runMultiResolutionDemons(demons,numIterations,pyramidLevels)
